...
<style>
  .singlebBillSimple_page {
    @if($billUiTheme['bgImage'])
      background-image: url('{{ asset($billUiTheme['bgImage']) }}');
            ...
            <div class="single_bill_content">
              ...
              <div class="table_items">
                <table>
                  <thead>
                    <tr>
                      <th class="@if(app()->getLocale() == 'ar') text-end @else text-start @endif">{{ __('Description') }}</th>
                      <th class="text-center">{{ __('Price') }}</th>
                      <th class="text-center">{{ __('Quantity') }}</th>
                      @if($bill->add_tax)
                      <th width="35%" class="@if(app()->getLocale() == 'ar') text-start @else text-end @endif">{{ __('Total include added tax') }}</th>
                      @else
                      <th width="35%" class="@if(app()->getLocale() == 'ar') text-start @else text-end @endif">{{ __('Total') }}</th>
                      @endif
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td class="@if(app()->getLocale() == 'ar') text-end @else text-start @endif">
                          {{ $item->product_name }}
                      ...
                      <td class="@if(app()->getLocale() == 'ar') text-start @else text-end @endif">
                      @if( $bill->add_tax)
              ...
              @if(isset($bill->user->settings->footer_bill))
                <p class="d-block mb-0 mt-2 text-break text-center">{{ $bill->user->settings->footer_bill }}</p>
              @endif
