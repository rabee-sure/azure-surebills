<div class="d-flex align-items-center justify-content-between gap-2">
    <p class="d-block mb-0">{{ __('Debit Note Date', [], $lang) }}</p>
    <p class="d-block mb-0">{{ $bill->created_at->format('d/m/Y')}}</p>
</div><!-- d-flex -->
<div class="d-flex align-items-center justify-content-between gap-2">
    <p class="d-block mb-0">{{ __('Debit Note Number', [], $lang) }}</p>
    <p class="d-block mb-0">{{ $bill->number }}</p>
</div><!-- d-flex -->

<div class="d-flex align-items-center justify-content-between gap-2">
    <p class="d-block mb-0">{{ __('Date', [], $lang) }}</p>
    <p class="d-block mb-0">{{ $bill->mainBill->created_at->format('d/m/Y')}}</p>
</div><!-- d-flex -->
...
<p class="d-block mb-0">{{ $bill->mainBill->number }}</p>
</div><!-- d-flex -->
