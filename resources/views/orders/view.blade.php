    ...
    <div class="col-12 col-ms-12 col-md-6 col-lg-8 col-xl-8 list mb-4" data-check-all="checkAll">
      ...
      <div class="card d-flex flex-row mb-3">
          <a class="d-flex" href=".html">
              <img src="../../images/fat-rascal-thumb.jpg" alt="Fat Rascal"
      ...
      <div class="card d-flex flex-row mb-3">
          <a class="d-flex" href=".html">
              <img src="../../images/goose-breast-thumb.jpg" alt="Goose Breast"
                  class="list-thumbnail responsive border-0 card-img-left" />
          </a>
          <div class="pl-2 d-flex flex-grow-1 min-width-zero">
              <div
      ...
      <div class="card d-flex flex-row mb-3">
          <a class="d-flex" href=".html">
              <img src="../../images/petit-gateau-thumb.jpg" alt="Petit Gateau"
                  class="list-thumbnail responsive border-0 card-img-left" />
          </a>
          <div class="pl-2 d-flex flex-grow-1 min-width-zero">
              <div
      ...
      <div class="card d-flex flex-row mb-3">
          <a class="d-flex" href=".html">
              <img src="../../images/salzburger-nockerl-thumb.jpg" alt="Salzburger Nockerl"
                  class="list-thumbnail responsive border-0 card-img-left" />
          </a>
          <div class="pl-2 d-flex flex-grow-1 min-width-zero">
              <div
