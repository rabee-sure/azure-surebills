...
<!-- Modal -->
<div class="modal fade" id="delete_customer_Modal_{{$role->id}}" tabindex="-1" role="dialog" aria-hidden="true">

 <div class="modal-dialog" role="document">
   <div class="modal-content">
     <div class="modal-header">
         <h5 class="modal-title" id="delete_customer_ModalLabel_{{$role->id}}">{{ __('Delete Role') }}</h5>
     ...
     <form action="{{ route('roles.destroy', $role->id)}}" method="post">
       <div class="modal-body">
         ...
         @else
           <h4 class="text-center m-0">{{ __('Are You sure Delete this Role?')}}</h4>
         @endif
       </div>
