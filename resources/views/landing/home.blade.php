...
@section('title', __('landing.nav.home'))
...
@section('content')
  <main class="grow flex flex-col gap-12 lg:gap-32 mb-10 lg:mb-18">
    ...
    <section id="hero" class="py-10 lg:py-16 overflow-hidden">
      <div class="container flex items-center justify-between flex-col lg:flex-row gap-12 lg:gap-6">
        <div class="w-full lg:w-1/2 ps-0 lg:ps-12">
          <h1 class="text-3xl lg:text-4xl text-center lg:text-start font-bold leading-relaxed lg:leading-normal text-black">{!! __('landing.hero.title_html') !!}</h1>
          <p class="text-base lg:text-lg font-normal leading-relaxed block text-[var(--MainColor)] mt-4 mb-8 text-center lg:text-start">
            {{ __('landing.hero.description') }}
          </p>
          <div class="flex items-center justify-center lg:justify-start gap-4">
            <a href="{{ url('/register') }}" title="{{ __('landing.hero.register_now') }}" class="flex items-center justify-center rounded px-4 py-3 text-base bg-[var(--PrimaryColor)] min-w-40 text-white font-medium transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              {{ __('landing.hero.register_now') }}
            </a>
            <a href="{{ url('/#how') }}" title="{{ __('landing.hero.how_it_works') }}" class="flex items-center justify-center rounded px-4 py-3 text-base bg-white min-w-40 text-[var(--MainColor)] font-medium transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              {{ __('landing.hero.how_it_works') }}
            </a>
          </div>
        ...
        <div class="w-full lg:w-1/2">
          <div class="flex items-center justify-center relative after:content-[''] after:absolute after:w-80 lg:after:w-96 after:h-80 lg:after:h-96 after:bg-[rgba(var(--PrimaryColorRGB),0.23)] after:rounded-full after:z-0 after:inset-auto h-auto lg:h-[550px] after:animate-leaves">
            <img src="{{ asset('assets/landing/images/intro_img.webp') }}" alt="{{ __('landing.hero.intro_image_alt') }}" class="relative z-10 max-w-full max-h-full">
          </div>
        </div><!-- 1/2 -->
      </div><!-- container -->
    </section><!-- hero -->
      ...
      <div class="container">
        <div class="flex items-center justify-between flex-col lg:flex-row gap-20 lg:gap-0">
          <div class="w-full lg:w-3/5 self-stretch p-0 lg:p-12 flex flex-col justify-center">
            <div class="txt-sm text-normal text-[--PrimaryColor] mb-3 inline-block" data-aos="fade-left" data-aos-duration="1000">
              {{ __('landing.about.label') }}
            </div>
            <span class="block text-3xl lg:text-4xl mb-2 font-bold text-black !leading-relaxed" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
              {!! __('landing.about.title_html') !!}
            </span>
            <p class="text-base lg:text-lg font-normal mb-6 text-[var(--MainColor)] !leading-relaxed" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
              {{ __('landing.about.description') }}
            </p>
            <ul class="space-y-3 mb-8 text-sm lg:text-base" data-aos="fade-left" data-aos-delay="700" data-aos-duration="1000">
              <li class="flex items-center justify-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-5 w-5 text-[var(--PrimaryColor)] mt-0.5 shrink-0"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                <span class="text-[--MainColor]">{{ __('landing.about.features.reliability') }}</span>
              </li>
              <li class="flex items-center justify-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-5 w-5 text-[var(--PrimaryColor)] mt-0.5 shrink-0"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                <span class="text-[--MainColor]">{{ __('landing.about.features.compliance') }}</span>
              </li>
              <li class="flex items-center justify-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-5 w-5 text-[var(--PrimaryColor)] mt-0.5 shrink-0"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                <span class="text-[--MainColor]">{{ __('landing.about.features.encryption') }}</span>
              </li>
              <li class="flex items-center justify-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-5 w-5 text-[var(--PrimaryColor)] mt-0.5 shrink-0"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                <span class="text-[--MainColor]">{{ __('landing.about.features.support') }}</span>
              </li>
            </ul>
          </div><!-- 3/5 -->
          <div class="w-full lg:w-2/5 relative">
            ...
            <div class="flex items-center justify-center bg-[#DCE5FF] rounded-xl animate-jumping relative z-10">
              <img src="{{ asset('assets/landing/images/about_img.webp') }}" alt="{{ __('landing.about.image_alt') }}" class="max-w-full max-h-full">
            </div>
    ...
    <section id="how" class="scroll-mt-32">
      <div class="container">
        <small class="block text-center text-base text-[--PrimaryColor] mb-4">{{ __('landing.how.label') }}</small>
        <span
          class="block text-2xl lg:text-4xl mb-4 text-center font-bold text-black leading-relaxed"
          data-aos="fade-up"
          data-aos-duration="1000"
        >
          {{ __('landing.how.title') }}
        </span>
        <p class="block text-center text-lg text-[--SecondaryColor] mb-12">{{ __('landing.how.description') }}</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white rounded-lg py-10 px-6 flex flex-col items-center justify-center shadow transition-all duration-300 hover:shadow-lg hover:-translate-y-2">
            ...
            <img src="{{ asset('assets/landing/images/how_img_1.webp') }}" alt="{{ __('landing.how.image_alt', ['step' => 1]) }}" class="max-w-full max-h-44 mb-8">
            <span class="block text-xl font-bold text-black mb-3">{{ __('landing.how.steps.register.title') }}</span>
            <span class="block text-base text-center text-[--MainColor] leading-relaxed">{{ __('landing.how.steps.register.description') }}</span>
          </div>
          <div class="bg-white rounded-lg py-10 px-6 flex flex-col items-center justify-center shadow transition-all duration-300 hover:shadow-lg hover:-translate-y-2">
            ...
            <img src="{{ asset('assets/landing/images/how_img_2.webp') }}" alt="{{ __('landing.how.image_alt', ['step' => 2]) }}" class="max-w-full max-h-44 mb-8">
            <span class="block text-xl font-bold text-black mb-3">{{ __('landing.how.steps.invoice.title') }}</span>
            <span class="block text-base text-center text-[--MainColor] leading-relaxed">{{ __('landing.how.steps.invoice.description') }}</span>
          </div>
          <div class="bg-white rounded-lg py-10 px-6 flex flex-col items-center justify-center shadow transition-all duration-300 hover:shadow-lg hover:-translate-y-2">
            ...
            <img src="{{ asset('assets/landing/images/how_img_3.webp') }}" alt="{{ __('landing.how.image_alt', ['step' => 3]) }}" class="max-w-full max-h-44 mb-8">
            <span class="block text-xl font-bold text-black mb-3">{{ __('landing.how.steps.track.title') }}</span>
            <span class="block text-base text-center text-[--MainColor] leading-relaxed">{{ __('landing.how.steps.track.description') }}</span>
          </div>
        </div>
      </div><!-- container -->
    </section><!-- how -->
    ...
    <section id="faqs" class="scroll-mt-32">
      <div class="container">
        <span class="block text-2xl lg:text-4xl mb-12 text-center font-bold text-black leading-relaxed">{!! __('landing.faqs.title_html') !!}</span>
        <div class="flex items-center justify-between flex-col lg:flex-row gap-8">
          <div class="w-full lg:w-2/5 flex items-center justify-center">
            <img src="{{ asset('assets/landing/images/faqs.webp') }}" alt="{{ __('landing.faqs.image_alt') }}" class="max-w-full max-h-96">
          </div><!-- 2/5 -->
            ...
            <div class="faq-grid flex flex-col gap-4">
              <article class="faq-item bg-white rounded-xl border border-gray-100 shadow overflow-hidden active reveal">
                <button class="faq-button w-full bg-white backdrop-blur-md p-4 flex items-center justify-between gap-3" type="button" aria-expanded="true">
                  <span class="grow block font-medium text-black text-start text-base lg:text-lg">{{ __('landing.faqs.items.what_is_surebills.question') }}</span>
                ...
                <div class="faq-panel grid grid-rows-[0fr] transition-all duration-300 ease-in-out">
                  <div class="faq-panel-inner overflow-hidden">
                    <p class="block break-words pb-4 px-4 m-0 text-[--MainColor] text-base leading-relaxed">{{ __('landing.faqs.items.what_is_surebills.answer') }}</p>
                  </div>
                </div>
              </article>
              ...
              <article class="faq-item bg-white rounded-xl border border-gray-100 shadow overflow-hidden reveal">
                <button class="faq-button w-full bg-white backdrop-blur-md p-4 flex items-center justify-between gap-3" type="button" aria-expanded="false">
                  <span class="grow block font-medium text-black text-start text-base lg:text-lg">{{ __('landing.faqs.items.withdraw_balance.question') }}</span>
                  <span class="faq-icon transition-all duration-300 ease-in-out text-lg font-bold shrink-0 w-9 h-9 rounded-lg bg-[rgba(var(--PrimaryColorRGB),0.19)] text-[--PrimaryColor] flex items-center justify-center">+</span>
                </button>
                <div class="faq-panel grid grid-rows-[0fr] transition-all duration-300 ease-in-out">
                  <div class="faq-panel-inner overflow-hidden">
                    <p class="block break-words pb-4 px-4 m-0 text-[--MainColor] text-base leading-relaxed">{{ __('landing.faqs.items.withdraw_balance.answer') }}</p>
                  </div>
                </div>
              </article>
              ...
              <article class="faq-item bg-white rounded-xl border border-gray-100 shadow overflow-hidden reveal">
                <button class="faq-button w-full bg-white backdrop-blur-md p-4 flex items-center justify-between gap-3" type="button" aria-expanded="false">
                  <span class="grow block font-medium text-black text-start text-base lg:text-lg">{{ __('landing.faqs.items.payment_methods.question') }}</span>
                  <span class="faq-icon transition-all duration-300 ease-in-out text-lg font-bold shrink-0 w-9 h-9 rounded-lg bg-[rgba(var(--PrimaryColorRGB),0.19)] text-[--PrimaryColor] flex items-center justify-center">+</span>
                </button>
                <div class="faq-panel grid grid-rows-[0fr] transition-all duration-300 ease-in-out">
                  <div class="faq-panel-inner overflow-hidden">
                    <p class="block break-words pb-4 px-4 m-0 text-[--MainColor] text-base leading-relaxed">{{ __('landing.faqs.items.payment_methods.answer') }}</p>
                  </div>
                </div>
              </article>
              ...
              <article class="faq-item bg-white rounded-xl border border-gray-100 shadow overflow-hidden reveal">
                <button class="faq-button w-full bg-white backdrop-blur-md p-4 flex items-center justify-between gap-3" type="button" aria-expanded="false">
                  <span class="grow block font-medium text-black text-start text-base lg:text-lg">{{ __('landing.faqs.items.service_fees.question') }}</span>
                  <span class="faq-icon transition-all duration-300 ease-in-out text-lg font-bold shrink-0 w-9 h-9 rounded-lg bg-[rgba(var(--PrimaryColorRGB),0.19)] text-[--PrimaryColor] flex items-center justify-center">+</span>
                </button>
                <div class="faq-panel grid grid-rows-[0fr] transition-all duration-300 ease-in-out">
                  <div class="faq-panel-inner overflow-hidden">
                    <p class="block break-words pb-4 px-4 m-0 text-[--MainColor] text-base leading-relaxed">{{ __('landing.faqs.items.service_fees.answer') }}</p>
                  </div>
                </div>
              </article>
            </div>
      ...
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="statistics_item flex flex-col items-center justify-center border border-[rgba(69,80,91,0.14)] rounded-xl py-8 px-4">
            ...
            <span class="text-2xl flex items-center justify-center gap-2 leading-relaxed font-bold text-black mb-2"><span class="text-[--PrimaryColor] text-4xl">{{ __('landing.statistics.clients.value') }}</span> {{ __('landing.statistics.clients.label') }}</span>
            <p class="text-base text-center text-[--MainColor]">{{ __('landing.statistics.clients.description') }}</p>
          </div>
          ...
          <div class="statistics_item flex flex-col items-center justify-center border border-[rgba(69,80,91,0.14)] rounded-xl py-8 px-4">
            ...
            <span class="text-2xl flex items-center justify-center gap-2 leading-relaxed font-bold text-black mb-2"><span class="text-[--PrimaryColor] text-4xl">{{ __('landing.statistics.invoices.value') }}</span> {{ __('landing.statistics.invoices.label') }}</span>
            <p class="text-base text-center text-[--MainColor]">{{ __('landing.statistics.invoices.description') }}</p>
          </div>
          ...
          <div class="statistics_item flex flex-col items-center justify-center border border-[rgba(69,80,91,0.14)] rounded-xl py-8 px-4">
            ...
            <span class="text-2xl flex items-center justify-center gap-2 leading-relaxed font-bold text-black mb-2"><span class="text-[--PrimaryColor] text-4xl">{{ __('landing.statistics.gateways.value') }}</span> {{ __('landing.statistics.gateways.label') }}</span>
            <p class="text-base text-center text-[--MainColor]">{{ __('landing.statistics.gateways.description') }}</p>
          </div>
          ...
          <div class="statistics_item flex flex-col items-center justify-center border border-[rgba(69,80,91,0.14)] rounded-xl py-8 px-4">
            ...
            <span class="text-2xl flex items-center justify-center gap-2 leading-relaxed font-bold text-black mb-2"><span class="text-[--PrimaryColor] text-4xl">{{ __('landing.statistics.support.value') }}</span> {{ __('landing.statistics.support.label') }}</span>
            <p class="text-base text-center text-[--MainColor]">{{ __('landing.statistics.support.description') }}</p>
          </div>
    ...
    <section id="contact" class="scroll-mt-20">
      <div class="container">
        <div class="bg-[rgba(var(--PrimaryColorRGB),0.05)] rounded-2xl p-4 lg:p-12">
          <div class="flex items-center justify-between flex-col lg:flex-row gap-8">
            <div class="w-full lg:w-1/2">
              <span class="block text-4xl mb-2 font-bold text-black leading-relaxed">{!! __('landing.contact.title_html') !!}</span>
              <p class="block text-base text-black leading-relaxed mb-6">{{ __('landing.contact.description') }}</p>
              <div class="flex flex-col gap-4">
                <a href="tel:8001110102" title="{{ __('landing.contact.phone') }}" class="flex items-center justify-start gap-4">
                  ...
                  <div class="flex flex-col items-start justify-center">
                    <span class="block text-sm text-[--MainColor] leading-relaxed">{{ __('landing.contact.phone') }}</span>
                    <span class="block text-base text-black leading-relaxed">8001110102</span>
                  </div>
                </a>
                <a href="https://api.whatsapp.com/send?phone=+966558946366" title="{{ __('landing.contact.whatsapp') }}" class="flex items-center justify-start gap-4">
                  <div class="flex items-center justify-center text-[--MainColor]">
                  ...
                  <div class="flex flex-col items-start justify-center">
                    <span class="block text-sm text-[--MainColor] leading-relaxed">{{ __('landing.contact.whatsapp') }}</span>
                    <span class="block text-base text-black leading-relaxed"><span dir="ltr">+966558946366</span></span>
                  </div>
                </a>
                <a href="mailto:bills@surepay.sa" title="{{ __('landing.contact.email') }}" class="flex items-center justify-start gap-4">
                  <div class="flex items-center justify-center text-[--MainColor]">
                  ...
                  <div class="flex flex-col items-start justify-center">
                    <span class="block text-sm text-[--MainColor] leading-relaxed">{{ __('landing.contact.email') }}</span>
            ...
            <div class="w-full lg:w-1/2 self-stretch flex flex-col justify-center">
              <form action="{{ route('contact.send_form') }}" id="contact_form" method="POST" class="flex flex-col gap-4">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="form-control flex flex-col gap-1">
                    <input type="text" value="{{ old('name') }}" name="name" id="name" placeholder="{{ __('landing.contact.form.name') }}" class="w-full border border-gray-300 rounded-lg px-4 py-0 h-12 outline-none text-black text-base placeholder:text-start text-start focus:border-[var(--PrimaryColor)] transition-all duration-300 invalid:border-pink-500 invalid:text-pink-600">
                  </div>
                  <div class="form-control flex flex-col gap-1">
                    <input type="email" value="{{ old('email') }}" name="email" id="email" inputmode="email" placeholder="{{ __('landing.contact.form.email') }}" class="w-full border border-gray-300 rounded-lg px-4 py-0 h-12 outline-none text-black text-base placeholder:text-start focus:border-[var(--PrimaryColor)] transition-all duration-300 invalid:border-pink-500 invalid:text-pink-600">
                  </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="form-control flex flex-col gap-1">
                ...
                <div class="form-control flex flex-col gap-1">
                  <textarea name="message" id="message" placeholder="{{ __('landing.contact.form.message') }}" class="w-full border border-gray-300 rounded-lg p-4 outline-none text-black text-base placeholder:text-start focus:border-[var(--PrimaryColor)] transition-all duration-300 invalid:border-pink-500 invalid:text-pink-600" rows="4">{{ old('message') }}</textarea>
                </div>
                <button type="submit" id="contact_submit_btn" class="w-full bg-[var(--PrimaryColor)] text-white rounded-lg px-4 py-0 h-12 outline-none transition-all duration-300 hover:shadow-xl hover:bg-[var(--PrimaryColorHover)] text-base font-bold disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                  <span id="contact_submit_label">{{ __('landing.contact.form.submit') }}</span>
                  <span id="contact_submit_spinner" class="hidden w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></span>
                </button>
              </form>
              <div id="contactErrorMessage" class="hidden mt-4 text-red-500 text-sm text-center leading-relaxed"></div>
              <div id="successMessage" class="hidden flex-col text-green-500 items-center justify-center">
                ...
                <span class="text-base leading-relaxed">{{ __('landing.contact.success_message') }}</span>
              </div><!-- successMessage -->
            </div><!-- 3/5 -->
          </div>
        </div>
...
<script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.min.js') }}?v={{ config('app.asset_version')}}"></script>
  <script>
    ...
    const submitLabel = document.getElementById('contact_submit_label');
    const submitSpinner = document.getElementById('contact_submit_spinner');
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        const formData = {
            source: @json(__('landing.contact.source')),
        ...
        .then(async (response) => {
            ...
            if (!response.ok) {
                ...
                throw new Error(data.message || @json(__('landing.contact.submit_error')));
            }
        ...
        .catch((error) => {
            showError(error.message || @json(__('landing.contact.submit_error')));
        })
        .finally(() => {
            setSubmitting(false);
        });
