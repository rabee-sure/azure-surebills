...
@section('content')
    <section id="main_slider">
      <div class="container">
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-6">
            <div class="imgthumb">
              <img src="{{ asset('images/slider_img1.svg') }}" alt="#">
            </div>
          </div><!-- col-12 -->
        </div><!-- row -->
      </div><!-- container -->
        ...
        <div class="how_work_slider owl-carousel owl-theme">
          <div class="item">
            <div class="item_inside">
              <div class="imgthumb">
                <img src="{{ asset('images/how_img1.svg') }}" alt="سجل معنا">
              </div><!-- imgthumb -->
              <span>سجل معنا</span>
          ...
          <div class="item">
            <div class="item_inside">
              <div class="imgthumb">
                <img src="{{ asset('images/how_img2.svg') }}" alt="أنشئ وشارك الفاتورة">
              </div><!-- imgthumb -->
          ...
          <div class="item">
            <div class="item_inside">
              <div class="imgthumb">
                <img src="{{ asset('images/how_img3.svg') }}" alt="تابع مبيعاتك">
              </div><!-- imgthumb -->
    ...
    <!-- <section id="prices">
      ...
      <div class="content">
        <div class="imgthumb">
          <img src="{{ asset('images/price_img.svg') }}" alt="#">
        </div>
        <ul>
      ...
      <div class="pay_icons">
        <img src="{{ asset('images/price_icons.svg') }}" alt="#">
      </div>
    </section>-->
        ...
        <div class="acc">
          ...
          <div class="acc__card">
            ...
            <div class="acc__panel">
              <p>لابد من إضافة رقم حسابك البنكي ومن ثم سيتم تحويل المبالغ من خلال حوالة مصرفية كل يومان من ايام العمل الرسمية بعد خصم رسوم الخدمة.</p>
            </div><!-- acc__panel -->
          </div><!-- acc__card -->
