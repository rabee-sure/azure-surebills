<table class="table table-striped text-center">
  <thead>
    <tr>
      ...
      <th>Total_amount_in_reversed</th>
      <th>Total_fee_with_vat</th>
      <th>Total_fee_with_vat_reversed</th>
      <th>Total_refund</th>
      <th>Total_refund_reversed</th>
  ...
  <tbody>
    @foreach($data as $raw)
      <tr>
        ...
        <td>{{ $raw->Total_amount_in_reversed }}</td>
        <td>{{ $raw->Total_fee_with_vat }}</td>
        <td>{{ $raw->Total_fee_with_vat_reversed }}</td>
        <td>{{ $raw->Total_refund }}</td>
        <td>{{ $raw->Total_refund_reversed }}</td>
