                ...
                <table width="98%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-bottom: 1px solid #000;padding: 5px;text-align: center;direction: ltr;font-weight: normal;font-size: 8pt;width: 50%;">{{ $refundedBill->bill->customer_name}}</td>
        ...
        <table class="table_title" style="width: 100%;">
          <tbody>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px solid #000;padding: 5px;text-align: center;direction: ltr;font-weight: normal;font-size: 8pt;width: 25%;">{{ $refundedBill->net_refunded_amount }} SAR</td>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px solid #000;padding: 5px;text-align: center;direction: ltr;font-weight: normal;font-size: 8pt;width: 25%;">{{ $refundedBill->refunded_vat }} SAR</td>
