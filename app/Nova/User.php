...
class User extends Resource
{
    ...
    protected function documents()
    {
        ...
        return array_merge($fields, [
            Files::make(__('Business Documents'), 'business_documents')
                ->hideFromDetail() // Hide the default field on the detail page
                ->hideFromIndex()
                ->rules(new ValidateUploadFile([
                    'png', 'jpg', 'jpeg', 'pdf', 'doc', 'docx', 'xlsx', 'csv'
            ])),
            ...
            Files::make(__('Bank Documents'), 'bank_documents')
            ->hideFromIndex()
            ->hideFromDetail()
            ->rules(new ValidateUploadFile(['png', 'jpg', 'jpeg', 'pdf', 'doc', 'docx', 'xlsx', 'csv'])),
