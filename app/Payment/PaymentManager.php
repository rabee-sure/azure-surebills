...
use App\Payment\Contracts\GetwayInterface;
...
class PaymentManager
{
    ...
    protected function validateDriver()
    {
        ...
        if (!$reflect->implementsInterface(GetwayInterface::class)) {
            throw new \Exception("Driver must be an instance of Contracts\GetwayInterface.");
        }
    }
}
