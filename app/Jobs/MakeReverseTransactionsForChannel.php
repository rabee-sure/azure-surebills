...
class MakeReverseTransactionsForChannel
{
    ...
    public function handle()
    {
        if(isset($this->bill->application) && isset($this->bill->application->channel)){
            ...
            $fee_trans->description = 'Fee - Channel: '.$this->bill->application->channel->name.' - reversed for payment failed';
            ...
            $vat_trans->description = 'Vat - Channel: '.$this->bill->application->channel->name.' - reversed for payment failed';
