...
class RefundReverseTransactionsForSureBills
{
    ...
    public function handle()
    {
        ...
        $fee_trans->description = 'REFUND Fee - Bill Number: '.$this->bill->number.' - Reversed Transaction For Failed Refund';
        ...
        $vat_trans->description = 'REFUND Vat - Bill Number: '.$this->bill->number.' - Reversed Transaction For Failed Refund';
