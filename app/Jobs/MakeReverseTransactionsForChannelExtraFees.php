...
class MakeReverseTransactionsForChannelExtraFees
{
    ...
    public function handle()
    {
        ...
        if(isset($this->bill->application) && isset($channel)){
            ...
            $fee_trans->description = 'channel extra - Channel: '.$channel->name.' - Reverse Transaction for failed payment';
            ...
            $vat_trans->description = 'channel extra Fees - Channel: '.$channel->name.' - Reverse Transaction for failed payment';
            ...
            $vat_trans->reference   = $this->bill->number;
            $vat_trans->description = 'channel extra Vat - Channel: '.$channel->name.' - Reverse Transaction for failed payment';
