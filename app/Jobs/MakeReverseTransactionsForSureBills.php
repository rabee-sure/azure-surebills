...
class MakeReverseTransactionsForSureBills
{
    ...
    public function handle()
    {
        ...
        if($user && isset($this->bill->payment_surebills_fees) && isset($this->bill->payment_surebills_fees_vat) ){
            ...
            $fee_trans->description = 'Fee - Bill Number: '.$this->bill->number.' - reversed for payment failed';
            ...
            $vat_trans->description = 'Vat - Bill Number: '.$this->bill->number.' - reversed for payment failed';
