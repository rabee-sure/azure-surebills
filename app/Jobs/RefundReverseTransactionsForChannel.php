...
class RefundReverseTransactionsForChannel
{
    ...
    public function handle()
    {
        if(isset($this->bill->application) && isset($this->bill->application->channel)){
            ...
            $fee_trans->description = 'REFUND Fee - Channel: '.$this->bill->application->channel->name.' - Reversed Transaction For Failed Refund';
            ...
            $vat_trans->description = 'REFUND Vat - Channel: '.$this->bill->application->channel->name.' - Reversed Transaction For Failed Refund';
