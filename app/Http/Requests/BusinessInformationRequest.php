...
class BusinessInformationRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
          ...
          'business_address.required' => __('business city required'),
          'business_address.regex' => __('business city must be english'),
          'business_address_details.required' => __('business address required'),
