...
class ApplePayController extends Controller
{
    public function validateMerchant(Request $request)
    {
        ...
        curl_setopt($ch, CURLOPT_SSLCERT, base_path('app/Payment/Drivers/MasterCardApplePay/key.pem'));
        curl_setopt($ch, CURLOPT_SSLKEY, base_path('app/Payment/Drivers/MasterCardApplePay/key2.pem'));
