...
class RecallMastercardWebhookForBillCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bills:recall-mastercard-webhook {bill_id}';
     ...
     * @var string
     */
    protected $description = 'Recall mastercard webhook to update payment log and insert transaction for bill_id';
    ...
    public function handle()
    {
        ...
        $masterCardResponse = $masterCardService->getBillStatusFromMasterCard($bill_id);
