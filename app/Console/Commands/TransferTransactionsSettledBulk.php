...
class TransferTransactionsSettledBulk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'transfer:transaction_settled_bulk {user_ids}';
     ...
     * @var string
     */
    protected $description = 'Command for re settled bulk of users for all these users transaction as per as his transfers';
    ...
    public function handle()
    {
        ...
        $user_ids = explode(",", $this->argument('user_ids'));
