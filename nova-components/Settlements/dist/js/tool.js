...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("c75bad58", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
    ...
    methods: {
        getUser: function getUser(id) {
            ...
            axios.get('/users/' + id).then(function (response) {
                ...
                _this.amount = _this.user.balance;
            });
            axios.get('/users/' + id + '/settlements').then(function (response) {
                _this.settlements = response.data.data;
            });
        },
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("Settlement for " + _vm._s(_vm.user.name))
      ]),
      _vm._v(" "),
        ...
        _c("div", { staticClass: "md:w-2/3" }, [
          _c("input", {
            ...
            attrs: {
              ...
              name: "amount",
              step: ".01",
              max: _vm.user.balance,
              id: "amount",
              disabled: _vm.user.balance == 0
            },
          ...
          _c("p", { staticClass: "text-gray-600 text-xs italic" }, [
            _vm._v("Make sure amount be less than or equal user balance")
          ]),
          _vm._v(" "),
          _c(
            "button",
